...
def tethys_command():
    ...
    scaffold_parser.add_argument('project_name', help='The name of the new Tethys app project to create.')
    ...
    gen_parser.add_argument('type', help='The type of object to generate.')
